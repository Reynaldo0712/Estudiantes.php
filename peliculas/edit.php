...
if (isset($_POST["estuId"]) && isset($_POST["Name"]) && isset($_POST["Apellido"]) && isset($_POST["CarreraId"]) && isset($_POST["Materia"])) {
    ...
    $estudiante = new Estudiante($_POST["estuId"], $_POST["Name"], $_POST["Apellido"], $_POST["CarreraId"], $_POST["Materia"], $_POST["Check"],$_POST["File"]);
...
<body>
    ...
    <?php if ($estudiante == null) : ?>
        ...
        <form action="edit.php" method="POST">
            ...
            <div class="mb-3">
                <input  type="radio" id="activo" name="Check" value="Activo">
                <label for="activo">activo</label><br>
                <input  type="radio" id="Inactivo" name="Check" value="Inactivo">
